...
const errors = {
  ...
  webapp_download_failed:
    'Failed to download the thingFX client. Make sure you have an active internet connection.',
  webapp_extract_failed: 'Failed to extract the thingFX client.'
}
